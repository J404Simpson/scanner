...
export declare class WorkerBridge {
    ...
    readonly copyArgs: {
        ...
        addPageToPdfWithOcr: (pdfOperation: import("../core-types").ObjectId<"PdfGenerationContext">, image: import("../core-types").Image) => Promise<void>;
        ...
        scanMRZ: <ImageType_2 extends import("../core-types").Image>(mrzScannerToken: import("../core-types").ObjectId<"MRZScannerContext">, image: ImageType_2, mode?: import("../core-types").MrzScanningMode) => Promise<import("../core-types").MrzScannerResult & {
