...
import { Image, DeepPartial, RawImage, ObjectId, Point, DocumentScannerParameters, DocumentDetectionResult, CroppedDetectionResult, BarcodeScannerConfiguration, BarcodeDocumentFormat, MrzScannerConfiguration, DocumentQualityAnalyzerConfiguration, ImageRotation, ParametricFilter, PdfConfiguration, TiffGeneratorParameters, DocumentDataExtractorConfiguration } from "./core-types";
...
export default class ScanbotSDK {
    ...
    createSimpleMRZRecognizer(config?: MrzScannerConfiguration): Promise<SimpleMrzRecognizer>;
    ...
    getBridge(consumeImage: ConsumeType): {
        ...
        scanMRZ: <ImageType_2 extends Image>(mrzScannerToken: ObjectId<"MRZScannerContext">, image: ImageType_2, mode?: Config.MrzScanningMode) => Promise<Config.MrzScannerResult & {
