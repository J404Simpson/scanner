...
export declare class WorkerBridge {
    ...
    readonly copyArgs: {
        ...
        addPageToPdfWithOcr: (pdfOperation: import("../worker/ScanbotSDK.Core").ObjectId<"PdfGenerationContext">, image: import("../worker/ScanbotSDK.Core").Image) => Promise<void>;
        ...
        scanMRZ: <ImageType_2 extends import("../worker/ScanbotSDK.Core").Image>(mrzScannerToken: import("../worker/ScanbotSDK.Core").ObjectId<"MRZScannerContext">, image: ImageType_2, mode?: import("./compiled/MrzTypes").MrzScanningMode) => Promise<import("./compiled/MrzTypes").MrzScannerResult & {
