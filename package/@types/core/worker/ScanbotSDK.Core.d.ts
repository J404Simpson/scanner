...
import { type MrzScannerResult, MrzScannerConfiguration, MrzScanningMode } from "../bridge/compiled/MrzTypes";
...
export declare const commands: {
    ...
    scanMRZ: <ImageType_2 extends Image>(mrzScannerToken: ObjectId<"MRZScannerContext">, image: ImageType_2, mode?: MrzScanningMode) => Promise<MrzScannerResult & {
